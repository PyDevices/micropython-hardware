...
This repo holds what used to live under pydisplay’s `board_configs/` and
`drivers/`. The pure-Python core (`displaysys`, `eventsys`, `graphics`,
`boarddev`, …) stays in [pydisplay](https://github.com/PyDevices/pydisplay).
