...
* Gate the prebuffer on :meth:`SDLOutputStream._hw_queued`, never on
  :meth:`SDLOutputStream.queued_size`. Counting bytes still sitting in the
...
* Do not let "the device is unpaused" mean playing in
  :meth:`SDLOutputStream.is_active` -- it stays unpaused for the life of the
