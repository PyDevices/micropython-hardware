...
see [Runtime](application-runtime.md).
...
[Runtime](application-runtime.md) and [Displays — timing](displaydev.md#timing).
...
Both prefer a native **`usdl2`** module when it is frozen or already present. Otherwise the pure-Python binding from [`pydevices-desktop`](https://pydevices.github.io/pydevices/pydevices-desktop.html) / the MIP desktop board (`drivers/usdl2.py`) provides `import usdl2`. See [Displays — SDLDisplay](displaydev.md#sdldisplay) and [MicroPython — Desktop SDL](https://pydisplay.readthedocs.io/en/latest/platforms/micropython/#desktop-sdl-usdl2).

## Next

- [Runtime](application-runtime.md)
- [Displays — timing](displaydev.md#timing)
- [Events](eventsys.md)
- [PyScript asyncio](https://pydisplay.readthedocs.io/en/latest/guides/pyscript-asyncio/)
